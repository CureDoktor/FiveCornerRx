...
export default function Switch() {
  ...
  function findRightOne() {
    let similarStrong: any = [];
    let similarDosage: any = [];

    medications.find((element: any) => {
    ...
    let objectMaking: any = [];
    let objectMakingTimes: any = [];
    similarStrong.forEach((object: any) =>
      objectMaking.push(returnObject(object))
    );
    similarDosage.forEach((object: any) =>
  ...
  const backToCheckout = async (medicationId: any) => {
